...
const validadeUserUpdateMiddleware_1 = require("../middleware/validadeUserUpdateMiddleware");
...
userRouter.put('/users/update/:id', validateJWT_1.validateJWT, validadeUserUpdateMiddleware_1.userUpdateValidation, userController.updateUser);
